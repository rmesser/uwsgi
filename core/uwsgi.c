...
static struct uwsgi_option uwsgi_base_options[] = {
	...
	{"subscription-restart-failed", no_argument, 0, "attempt to restart failed subscriptions rather than remove them", uwsgi_opt_true, &uwsgi.subscription_restart_failed, 0},
